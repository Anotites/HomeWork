...
public class CalculatorStringExpression {
    ...
    // Я понимаю, что мой класс не соответствует требованиям 14 задания в части ООП (и, честно говоря,
    // часть решения я подсмотрела, усложнив для конкретных условий, то есть в найденном примере не было проверок
    // и было только сложение-вычитание-умножение-деление без Pi, E, степеней и т.д.).
    // Но решила оставить в ДЗ, чтобы потом сравнить с верным решением.
