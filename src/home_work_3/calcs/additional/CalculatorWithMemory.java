...
public class CalculatorWithMemory {
    ...
    /**
     * Метод, сохраняющий значение return последнего вызванного в Main метода из этого класса.
     * Если метод с данным названием будет далее встречаться в этом пакете, то он
     * будет выполнять такое же действие.
     */
    public void save() {
        finalResult = result;
    }
    ...
    /**
     * Метод, возвращающий значение return последнего вызванного в Main метода из этого класса.
     * Если метод с данным названием будет далее встречаться в этом пакете, то он
     * будет выполнять такое же действие.
     *
     * @return Значение return последнего вызванного в Main метода из этого класса.
     */
    public double load() {
        save();
        result = 0;
