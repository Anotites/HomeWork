...
Файлы для 2.4, 3.4, 5.4 у меня сохранены в папке IdeaProjects\JD1 (чтобы путь не прописывать), но так как к нему нет доступа git, так же добавила аналогичные файлы в IdeaProjects\JD1\HomeWork.

Тесты для методов этого пакета выполнены в пакете home_work_4.additional.collections.